...
export default [
  ...
  { path: '/equipment-records/ph-sensor', name: 'equipment-records.ph-sensor.index', component: page('equipment-records/ph-sensor/index.vue') },
  { path: '/equipment-records/ec-sensor', name: 'equipment-records.ec-sensor.index', component: page('equipment-records/ec-sensor/index.vue') },
  { path: '/equipment-records/level-sensor', name: 'equipment-records.level-sensor.index', component: page('equipment-records/level-sensor/index.vue') },
  { path: '/equipment-records/pump1', name: 'equipment-records.pump1.index', component: page('equipment-records/pump1/index.vue') },
  { path: '/equipment-records/pump2', name: 'equipment-records.pump2.index', component: page('equipment-records/pump2/index.vue') },
  { path: '/equipment-records/pump3', name: 'equipment-records.pump3.index', component: page('equipment-records/pump3/index.vue') },
